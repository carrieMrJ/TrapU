...
public class ArgumentParser {
    ...
    /**
     * set local color in remote play
     * @return integer value, 1 refers to color red, 0 refers to color blue
     * @throws ArgumentParserException self defined Exception
     */
    public int localColor() throws ArgumentParserException {
    	return Integer.parseInt((String) getSetting("meRed"));
    }
    
    /**
     * set match number of tournament
     * @return integer value
     * @throws ArgumentParserException self defined Exception
     */
    public int getMatch() throws ArgumentParserException {
    	return Integer.parseInt((String) getSetting("match"));
    }
    
    /**
     * set remote host in remote play
     * @return string value
     * @throws ArgumentParserException self defined Exception
     */
    public String remoteHost() throws ArgumentParserException {
    	return (String) getSetting("remoteHost");
    }
    
    /**
     * set local host in remote play
     * @return string value
     * @throws ArgumentParserException self defined Exception
     */
    public String localHost() throws ArgumentParserException {
    	return (String) getSetting("localHost");
    }
}
